function clock() {
    var secDots = document.getElementById('secDots');
    var minDots = document.getElementById('minDots');
    var hrDots = document.getElementById('hrDots');
    ...
    var secondsDots = '';
    for (var i = 1; i < 61; i++) {
        var rotation = i * 6; // rotate each line by 6 degrees
        if (i === seconds) {
    ...
    var hoursDots = '';
    for (var i = 1; i < 13; i++) {
        var rotation = i * 30; // rotate each line by 30 degrees
        if (i === hours) {
...
// add zero in single digital number
